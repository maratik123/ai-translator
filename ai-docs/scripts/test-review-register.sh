...
emit \
  ...
  '|----|--------|----------|--------|-------------------|' \
  '| R1-1 | round 1 | major | open | mutate x, cargo test — must go RED |' \
  '| R1-2 | round 1 | minor | fixed@abc1234 | mutate y, cargo test — must go RED |' '' \
  '## Self-Review (Round 1)' '' \
  '**Verdict:** REJECT' '' \
  '| # | File:line | Severity | Finding | Status |' \
  '|---|-----------|----------|---------|--------|' \
  '| 1 | crates/core/src/caller.rs:106 | major | A multipart request is retried | ✅ Fixed |' \
  '| 2 | crates/core/src/limit.rs:210 | minor | False doc comment | ✅ Fixed |'
...
emit \
  ...
  '| id | raised | severity | status | verifying command |' \
  '|----|--------|----------|--------|-------------------|' \
  '| R1-1 | round 1 | major | fixed@abc1234 | mutate x, cargo test — must go RED |' \
  '| R1-2 | round 1 | minor | fixed@abc1234 | mutate y, cargo test — must go RED |' '' \
  '## Self-Review (Round 1)' '' \
  '**Verdict:** REJECT' '' \
  '| # | File:line | Severity | Finding | Status |' \
...
emit \
  ...
  '| # | File:line | Severity | Finding | Status |' \
  '|---|-----------|----------|---------|--------|' \
  '| 1 | a.rs:1 | major | one | ✅ Fixed |' \
  '| 2 | b.rs:2 | minor | two | ✅ Fixed |'
...
emit \
  ...
  '| # | File:line | Severity | Finding | Status |' \
  '|---|-----------|----------|---------|--------|' \
  '| 1 | a.rs:1 | major | one | ⬜ Open 🔁 Re-opened |'
...
emit \
  ...
  '| # | File:line | Severity | Finding | Status |' \
  '|---|-----------|----------|---------|--------|' \
  '| 5 | a.rs:1 | major | one | ✅ Fixed |' '' \
  '## Self-Review (Round 2)' '' \
  '| # | File:line | Severity | Finding | Status |' \
  '|---|-----------|----------|---------|--------|' \
  '| 1 | a.rs:1 | major | R1-5 — re-opened: the fix missed a second caller | ✅ Fixed |'
...
emit \
  ...
  '| # | File:line | Severity | Finding | Status |' \
  '|---|-----------|----------|---------|--------|' \
  '| 1 | a.rs:1 | major | `R1-5` re-opened | ✅ Fixed |'
...
emit \
  ...
  '| # | File:line | Severity | Finding | Status |' \
  '|---|-----------|----------|---------|--------|' \
  '| 1 | a.rs:1 | minor | 2-3 retries where one was meant | ✅ Fixed |'
