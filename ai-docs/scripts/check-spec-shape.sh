...
bare_ref='(^|[^A-Za-z0-9_/.:-])[A-Za-z0-9_.][A-Za-z0-9_./-]*\.(md|rs|sh|sql|yml|yaml|json|toml|lock)(:[0-9]+)(-[0-9]+)?([^0-9A-Za-z]|$)'
# Two pins: a commit prefix and a module version -- both name the tree they
# were read on.
pinned='([0-9a-f]{7,40}:[A-Za-z0-9_.][A-Za-z0-9_./-]*|[A-Za-z0-9_./-]+@v?[0-9][A-Za-z0-9_.+-]*/[A-Za-z0-9_./-]*)\.(md|rs|sh|sql|yml|yaml|json|toml|lock):[0-9]+'
