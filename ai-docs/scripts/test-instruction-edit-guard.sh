...
check_bash BLOCK live "cd /home/dev/ai-translator && sed -i.orig 's/a/b/' CLAUDE.md"
...
check_edit ALLOW live "crates/core/src/config.rs"
...
check_edit ALLOW live "/home/someone/.claude/projects/-home-someone-ai-translator/memory/feedback.md"
