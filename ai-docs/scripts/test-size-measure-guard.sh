...
BLOCK wc -l -c /work/ai-translator/AGENTS.md /work/ai-translator/.claude/agents/self-review.md
BLOCK LC_ALL=C.UTF-8 wc -m -c /work/ai-translator/AGENTS.md /work/ai-translator/.claude/agents/self-review.md
