...
- [ ] `testdata/models/`: мини-модели для тестов конформности клиента, закоммичены вместе с инструкцией происхождения и лицензиями. Продакшен-веса остаются в `models/` и в `.gitignore` — это разные вещи, и директории названы по-разному намеренно.
