...
- \`crates/core/src/a.rs\` — added a thing
- \`crates/core/src/b.rs\` — changed a thing
- \`crates/core/src/c.rs\` — removed a thing
...
**Branch:** feat/fixture
**Issue:** https://github.com/maratik123/ai-translator/issues/42
...
assert_jq "case 1: files_touched (3 paths)"    "$l1" \
  '.files_touched == ["crates/core/src/a.rs","crates/core/src/b.rs","crates/core/src/c.rs"]'
