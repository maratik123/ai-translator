...
```
`-ot` не нужен: под ROCm модель влезает в VRAM целиком (14.34 ГБ, с MTP 14.71 — голова стоит 382 МБ). Vulkan для этой модели медленнее
(89 с) и, главное, нестабилен — с офлоадом разброс достигает 20%.
